...
export const WhatIf = ({
	...
	const [selectedScenarioType, setSelectedScenarioType] =
		useState<WhatIfScenario5110TypeId | null>(scenarioOptions[0]?.id ?? null);
	...
	const runSimulationWithCurrentInputs = useCallback(async (): Promise<{
		...
		const normalizedFrames = Array.isArray(result.frames) ? result.frames : [];
