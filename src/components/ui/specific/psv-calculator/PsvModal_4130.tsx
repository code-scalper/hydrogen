...
const INPUT_ITEMS = [
  { title: "고압 뱅크 입력 변수", items: DEVICES.HBk.props, x: 40, y: 220 },
  {
...
export const PsvModal_4130 = ({ onCreate }: PsvCalculatorModalProps) => {
        ...
        <div className="relative flex-1 p-4 overflow-auto h-full">
          ...
          <div className="absolute inset-x-0 top-0 p-5 overflow-hidden h-full">
            <img
              src={SFC4130}
              alt="psv1"
              className="block ml-auto max-w-full h-auto relative left-[-50px] top-[140px]"
            />
          </div>
