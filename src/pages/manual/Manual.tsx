			...
			<div className="relative mx-auto flex max-w-5xl flex-col gap-12 px-6 py-16">
					...
					<div className="flex flex-col gap-6 text-slate-200">
						<header className="flex flex-col gap-3">
							...
							<p className="max-w-3xl text-base leading-relaxed text-slate-300">
								주요 기능을 빠르게 이해하고 사용할 수 있도록 핵심 동작을
								정리했습니다. 아래 안내를 따라 프로젝트를 관리하고 시나리오를
								설정해 효율적인 시뮬레이션 환경을 구축해 보세요.
							</p>
						</header>
				...
				>
					<div className="flex flex-col gap-3 text-slate-200">
						...
						<p className="text-base leading-relaxed text-slate-300">
							화면 좌측의 네비게이션 바를 활용하면 작업 흐름을 빠르게 전환할 수
							있습니다. 각 버튼은 다음과 같은 기능을 제공합니다.
						</p>
					</div>
				...
				<section className="rounded-3xl border border-slate-800 bg-gradient-to-r from-sky-900/60 via-slate-900/80 to-indigo-900/60 p-8 shadow-xl shadow-slate-950/30">
					<div className="flex flex-col gap-3 text-slate-200">
						...
						<p className="text-base leading-relaxed text-slate-100">
							화면 하단의{" "}
							<span className="font-semibold text-sky-200">Time Interval</span>{" "}
							패널은 향후 시뮬레이션 결과를 시간의 흐름에 따라 재생하는 역할을
							맡게 됩니다. 결과 데이터가 확보되면 구간별 변화를 순차적으로
							확인하며 실제 운영과 유사한 경험을 제공할 예정입니다.
						</p>
						<p className="text-sm leading-relaxed text-slate-300">
							현재는 시간대를 미리 구성하는 용도로 활용하며, 추후 업데이트 시
							과거-현재-미래 구간의 상태 변화를 직관적으로 비교할 수 있도록
							시각화가 추가될 계획입니다.
						</p>
					</div>
				</section>
