...
const withScenarioDefaults = <T extends object>(
	...
	const scenarioDefaults = SCENARIO_5110_DEFAULTS[typeId] as
...
export const getScenario5110WhatIfDefaults = (
	...
	withScenarioDefaults(typeId, WHAT_IF_FIELD_KEYS, DEFAULT_WHAT_IF_INPUTS);
...
const WHAT_IF_VEHICLE_FIELD_KEYS = WHAT_IF_VEHICLE_FIELDS.map(
	(field) => field.key,
);
